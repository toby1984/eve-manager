 ...
 * own renderer, please keep this performance consideration in mind. <p>
 * 
 ...
 * @see JTable
 */
public abstract class AbstractSpreadSheetTableCellRenderer extends JLabel
		implements TableCellRenderer
{
	 ...
	 */
	public AbstractSpreadSheetTableCellRenderer() {
		super();
		setOpaque(true);
	...
	{
		Border border = (Border) DefaultLookup.get(this, ui,
	...
	/**
	 * 
	 * Returns the default table cell renderer. <p> During a printing operation,
	 * this method will be called with <code>isSelected</code> and
	 * <code>hasFocus</code> values of <code>false</code> to prevent selection
	 * and focus from appearing in the printed output. To do other customization
	 * based on whether or not the table is being printed, check the return
	 * value from {@link javax.swing.JComponent#isPaintingForPrint()}.
	 * 
	 * @param table
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        if (dropLocation != null
            ...
            fg = (Color) DefaultLookup.get(this, ui, "Table.dropCellForeground");
            bg = (Color) DefaultLookup.get(this, ui, "Table.dropCellBackground");
        ...
        if (isSelected) {
            ...
            if (background == null || background instanceof javax.swing.plaf.UIResource) {
                Color alternateColor = (Color) DefaultLookup.get(this, ui, "Table.alternateRowColor");
    ...
    renderHook( table , value , row , column , isSelected);
    
	if (hasFocus) {
            Border border = null;
            if (isSelected) {
                border = (Border) DefaultLookup.get(this, ui, "Table.focusSelectedCellHighlightBorder");
            }
            if (border == null) {
                border = (Border) DefaultLookup.get(this, ui, "Table.focusCellHighlightBorder");
            }
            setBorder(border);

	    if (!isSelected && table.isCellEditable(row, column)) {
                Color col;
                col = (Color) DefaultLookup.get(this, ui, "Table.focusCellForeground");
                if (col != null) {
                    super.setForeground(col);
                }
                col = (Color) DefaultLookup.get(this, ui, "Table.focusCellBackground");
                if (col != null) {
	...
	{
		setText( getLabelFor(table, value, row, column) );
	}
	 ...
	 * <code>DefaultTableCellRenderer</code> subclasses. <p>
	 * <strong>Warning:</strong> Serialized objects of this class will not be
	 ...
	 * .
	 */
	public static class UIResource extends AbstractSpreadSheetTableCellRenderer
